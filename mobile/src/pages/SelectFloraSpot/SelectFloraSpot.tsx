...
const SelectFloraSpot: React.FC = () => {
  ...
  return (
    <MapContainer>
      ...
      >
        {markerCoordinates && (
          <Marker coordinate={markerCoordinates}>
            <MarkerIcon source={require("../../assets/flora_marker.png")} />
          </Marker>
        )}
      </Map>
      {markerCoordinates ? (
      ...
      <BackButton onPress={() => navigate("register_flora")} />
    </MapContainer>
  );
};

export default SelectFloraSpot;
